...
class SiteBuildTests(unittest.TestCase):
    ...
    def test_signing_copy_follows_selected_release_not_version_number(self):
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertIn("Signing does not turn off", html)
            self.assertIn("Microsoft Defender SmartScreen separately checks", html)
            self.assertIn("https://learn.microsoft.com/en-us/windows/apps/package-and-deploy/smartscreen-reputation", html)
